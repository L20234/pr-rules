...
async function main() {
    ...
    try {
        ...
        if (exec_errors.length) {
            ...
            linter_report.push("If you have any questions, please contact DevOps team\nazadeh.ghaffari@litens.com")
...
function isPrTitleValid(regexes, pr_title) {
    ...
    try {
        ...
        core.error("Contact DevOps team <azadeh.ghaffari@litens.com>")
        return false
    }
}
